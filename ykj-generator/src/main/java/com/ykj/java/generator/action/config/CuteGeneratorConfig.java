 ...
 *
 * @author ykj
 * @date 2018-5-28-下午8:27
 */
public class CuteGeneratorConfig extends AbstractGeneratorConfig {
    ...
    protected void dataSourceConfig() {
        ...
        dataSourceConfig.setUrl("jdbc:mysql://127.0.0.1:3306/ykj?characterEncoding=utf8");
    }
    ...
    protected void packageConfig() {
        ...
        packageConfig.setEntity("com.ykj.java.admin.common.persistence.entity");
        packageConfig.setMapper("com.ykj.java.admin.common.persistence.dao");
        packageConfig.setXml("com.ykj.java.admin.common.persistence.dao.mapping");
    }

    protected void contextConfig() {
        contextConfig.setProPackage("com.ykj.java.admin");
        contextConfig.setCoreBasePackage("com.ykj.java.core");
        contextConfig.setBizChName("字典管理");
        contextConfig.setBizEnName("sysDict");
        contextConfig.setModuleName("system");
        contextConfig.setProjectPath("D:\\ideaSpace\\ykj\\ykj-admin");//写自己项目的绝对路径
