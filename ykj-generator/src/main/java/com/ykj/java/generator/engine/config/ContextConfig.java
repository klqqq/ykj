package com.ykj.java.generator.engine.config;
...
public class ContextConfig {
    ...
    private String templatePrefixPath = "cuteTemplate/advanced";
    private String projectPath = "D:\\ideaSpace\\ykj";//模板输出的项目目录
    ...
    private String proPackage = "com.ykj.java.admin";
    private String coreBasePackage = "com.ykj.java.core";
    private String modelPackageName = "com.ykj.java.modular.system.entity";        //model的包名
    private String modelMapperPackageName = "com.ykj.java.modular.system.dao";    //model的dao
