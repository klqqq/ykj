...
package com.ykj.java.core.flowable;
 ...
 */
public class YkjDefaultProcessDiagramGenerator implements ProcessDiagramGenerator {
    ...
    public YkjDefaultProcessDiagramGenerator() {
        this(1.0);
    }

    // The instructions on how to draw a certain construct is
    // created statically and stored in a map for performance.
    public YkjDefaultProcessDiagramGenerator(final double scaleFactor) {
        // start event
