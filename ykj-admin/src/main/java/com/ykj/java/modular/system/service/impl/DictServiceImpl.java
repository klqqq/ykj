...
import com.ykj.java.modular.system.dao.DictMapper;
import com.ykj.java.modular.system.model.Dict;
import com.ykj.java.modular.system.service.IDictService;
import com.ykj.java.core.common.constant.factory.MutiStrFactory;
...
public class DictServiceImpl extends ServiceImpl<DictMapper, Dict> implements IDictService {
    ...
    public void addDict(String dictName, String dictValues) {
        ...
        if (dicts != null && dicts.size() > 0) {
            throw new YkjException(BizExceptionEnum.DICT_EXISTED);
        }
        ...
        for (Map<String, String> item : items) {
            ...
            try {
                ...
                throw new YkjException(BizExceptionEnum.DICT_MUST_BE_NUMBER);
            }
