package com.ykj.java.modular.code.factory;


import com.ykj.java.YkjApplication;
import com.ykj.java.core.CoreFlag;
import com.ykj.java.core.util.ToolUtil;
import com.ykj.java.generator.action.model.GenQo;
...
public class DefaultTemplateFactory {
    ...
    public static GenQo getDefaultParams(){
        ...
        genQo.setAuthor("ykj");
        genQo.setProjectPackage(YkjApplication.class.getPackage().getName());
