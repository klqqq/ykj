...
import com.ykj.java.core.common.constant.dictmap.MenuDict;
import com.ykj.java.core.common.constant.factory.ConstantFactory;
import com.ykj.java.core.common.constant.state.MenuStatus;
...
import com.ykj.java.core.support.BeanKit;
import com.ykj.java.core.util.ToolUtil;
import com.ykj.java.modular.system.model.Menu;
import com.ykj.java.modular.system.service.IMenuService;
import com.ykj.java.modular.system.warpper.MenuWarpper;
...
public class MenuController extends BaseController {
    ...
    public Tip add(@Valid Menu menu, BindingResult result) {
        ...
        if (ToolUtil.isNotEmpty(existedMenuName)) {
            throw new YkjException(BizExceptionEnum.EXISTED_THE_MENU);
        }
    ...
    private void menuSetPcode(@Valid Menu menu) {
        if (ToolUtil.isEmpty(menu.getPcode()) || menu.getPcode().equals("0")) {
            ...
            if (menu.getCode().equals(menu.getPcode())) {
                throw new YkjException(BizExceptionEnum.MENU_PCODE_COINCIDENCE);
            }
